...
const socials =[
  {Icon : BsTwitterX , label : "X",href : "https://x.com/Bala_Sarathi"},
  {Icon : FaLinkedinIn , label : "LinkedIn",href : "https://www.linkedin.com/in/bala-sarathi-827428257"},
  {Icon : FaGithub , label : "GitHub",href : "https://github.com/Balasarathi29"}
]
const glowvariants = {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <main className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols lg:grid-cols-2">
          <div className="flex flex-col justify-center h-full text-center lg:text-left relative ">
            <div className="w-full lg:pr-24 mx-auto max-w-[48rem] ">
              <motion.div
                className="mb-3 text-xl sm:text-2xl md:text-3xl lg:font-4xl font-semibold text-white tracking-wide min-h-[1.6em]"
              ...
              transition={{ duration: 0.8, delay: 0.8 }}>
                ...
                <a href="/ATS Resume.pdf" download className="px-6 py-3 rounded-full font-medium text-lg text-black bg-white hover:bg-gray-200 shadow-lg hover:scale-105 transition-all">My Resume</a>
              </motion.div>
          ...
          <div  className="absolute top-1/2 -translate-y-1/2 pointer-events-none" style={{
            ...
            <motion.img src={avator} alt="Bala"
